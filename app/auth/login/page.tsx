...
export default function LoginPage() {
    return (
        <main className="flex flex-col lg:flex-row min-h-screen bg-white font-[var(--font-nunito-sans)]">
            ...
            <div className="w-full lg:w-[45%] xl:w-[42%] flex flex-col p-6 sm:p-10 lg:p-14 xl:p-20 overflow-y-auto justify-center">
                {/* Logo */}
                ...
                <div className="mb-10 lg:mb-12">
                    <h1 className="text-3xl sm:text-4xl font-bold text-black leading-[1.2]">
                        Welcome Back to <br className="hidden sm:block" /> <span className="text-[#e8961e]">Moatt 3D</span>
                    </h1>
                    <p className="text-gray-400 mt-4 text-sm sm:text-base font-medium">
                        Login to your account to continue designing
                    </p>
                </div>
                ...
                <form className="flex flex-col gap-6">
                    ...
                    <div className="flex justify-end">
                        <Link href="#" className="text-xs sm:text-sm font-bold text-[#e8961e] hover:underline">Forgot Password?</Link>
                    </div>

                    <button
                        type="submit"
                        className="w-full bg-[#e8961e] text-white font-bold py-4 sm:py-5 rounded-full mt-2 hover:bg-[#d18619] transition-all shadow-md shadow-orange-500/10 text-sm tracking-wide"
                    >
                        Login Now
                    </button>
                </form>
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-12">
                    <button className="flex-1 flex items-center justify-center gap-3 border border-gray-100 bg-[#f9f9f9] py-3.5 sm:py-4 rounded-full text-xs sm:text-sm font-bold hover:bg-gray-50 transition-all shadow-sm">
                        <FcGoogle className="text-xl sm:text-2xl" /> Sign In With Google
                    </button>
                    <button className="flex-1 flex items-center justify-center gap-3 border border-gray-100 bg-[#f9f9f9] py-3.5 sm:py-4 rounded-full text-xs sm:text-sm font-bold hover:bg-gray-50 transition-all shadow-sm">
                        <FaApple className="text-xl sm:text-2xl" /> Sign In With Apple
                    </button>
                </div>

                {/* Register Redirect */}
                <p className="text-center text-sm font-medium text-gray-500">
                    Don't have an account? <Link href="/auth/register" className="text-[#e8961e] font-extrabold ml-1 hover:underline">Register</Link>
                </p>
            </div>
